...
Los datos del gráfico muestra que 6 integrantes de la familia pueden generar un ingreso promedio mensual de 3000 soles, seguido de 2 integrantes que pueden generar un ingreso que varie de 500 a 1500 soles, tambien se observa que 5 integrantes tienen un promedio mensual que varia entre 600 a 700 soles.
	...
	\end{figure}
	El dato del gráfico muestra que los pobladores de la comunidad de Chilloroya no pagan al comité de gestión. lo cual podría indicar que la comunidad tiene entendido sobre el derecho de acceso al agua, además existe un principio de seguridad de el agua donde se promueve y vela por este recurso hídricos\\
	\\
